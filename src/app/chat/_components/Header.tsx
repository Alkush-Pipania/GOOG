...
const Header = () => {
  ...
  return (
    <section className='flex  from-GoogBG to-transparent via-GoogBG bg-gradient-to-b  justify-between w-full px-5  fixed top-0 items-center  py-4'>
      <Link href={'/'}>
      ...
      <div className='flex items-center justify-between gap-2'>
        ...
        <HoverCard openDelay={3} closeDelay={3} >
          <HoverCardTrigger>
            <Button className='hover:bg-zinc-700 cursor-pointer duration-150 ease-in-out rounded-full'>
              <AlignLeft />
            </Button>
          </HoverCardTrigger>
          <HoverCardContent className='bg-zinc-700 w-fit border-none text-white p-2 text-sm'>
